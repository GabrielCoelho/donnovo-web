...
<div class="bg-grey mx-auto" style="background: 
    url('<?= get_template_directory_uri();?>/assets/images/Sobre.jpeg')">>
        <div class="container">
            <div class="row pt-5">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-4 offset-sm-1">
                    ...
                    <p class="fonte-simples">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Reiciendis, quidem assumenda 
