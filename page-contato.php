...
<div class="bg-grey mx-auto" style="background: 
    url('<?= get_template_directory_uri();?>/assets/images/Contato.jpeg')">
        <div class="container">
            <div class="row pt-5">
            ...
            <div class="col-xs-12 col-sm-5 offset-sm-1">
                ...
                <div class="row my-2">
                    <a href="https://www.facebook.com/donnovoalimentos/" target="_blank">
                        <img src="<?= get_template_directory_uri();?>/assets/images/facebook.svg" alt="" class="envinfos-ic">
                    </a>
                   <a href="https://www.facebook.com/donnovoalimentos/" target="_blank">
                        <img src="<?= get_template_directory_uri();?>/assets/images/instagram.svg" alt="" class="envinfos-ic">
                    </a>
                </div>
